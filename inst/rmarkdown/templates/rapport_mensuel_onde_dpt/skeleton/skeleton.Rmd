...
Le **département `r params$code_departement`** est couvert par **XX stations** d'observations. Pour chaque campagne usuelle, un indice ONDE peut être calculé selon la formule suivante :
