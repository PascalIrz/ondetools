...
#'
#' Cette fonction permet d'ajouter au fichier géographique des stations les attributs caractérisant les assecs.
#'     La correspondance se fait par une jointure sur les codes des stations CdSiteHydro.
#'
