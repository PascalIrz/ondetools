...
#'
#' Rapports pour plusieurs départements (ex: 14, 27, 76) pour le mois de juin 2023 ('2023_06')
#'
#' produire_rapport_mensuel_dpt(onde_df = donnees_onde,
    ...
    furrr::future_walk(code_departement,
                       ~ {
                         ...
                         rmarkdown::render(
                           ...
                           output_file = glue::glue("Bilan_ONDE_mensuel_{annee_mois}_SD_{.x}.docx"),
                         ...
                         cli::cli_alert_success(glue::glue("rapport dpt. {.x} - p\u00e9riode de {annee_mois} - OK !!! (cf. dossier {dossier_sortie})"))
